...
class staff_stock_menu(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.stock_table.setHorizontalHeaderLabels([
            ...
            "총 물량", "재고량", "판매량"])
        self.stock_table.setItem(0, 0, QTableWidgetItem("1"))
        self.stock_table.setItem(0, 1, QTableWidgetItem("2"))
        self.stock_table.setItem(0, 2, QTableWidgetItem("3"))
        self.stock_table.setItem(0, 3, QTableWidgetItem("4"))
        self.stock_table.setItem(1, 0, QTableWidgetItem("5"))
        self.stock_table.setItem(1, 1, QTableWidgetItem("6"))
        self.stock_table.setItem(1, 2, QTableWidgetItem("7"))
        self.stock_table.setItem(1, 3, QTableWidgetItem("8"))
        self.stock_table.setItem(2, 0, QTableWidgetItem("9"))
        self.stock_table.setItem(2, 1, QTableWidgetItem("10"))
...
class manager_stock_delete(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.setGeometry(150, 300, 610, 500)
        self.setWindowTitle('[관리자 메뉴] 재고 관리 - 상품 삭제')
        self.show()
...
class sudo_menu_searchmenu(QMainWindow):
    def __init__(self, parent=None):
        ...
        con = pymysql.connect(host=HOST, user="root", password="1234", db='mydb', charset='utf8')
        cur = con.cursor()
