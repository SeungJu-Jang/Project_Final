...
class sudo_menu_searchmenu(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.positionlabel_txt.setGeometry(QtCore.QRect(360, 180, 100, 100))
        ...
        self.idlabel_txt.setGeometry(QtCore.QRect(350, 220, 100, 100))
        ...
        self.birthlabel_txt.setGeometry(QtCore.QRect(390, 260, 100, 100))
        ...
        self.emaillabel_txt.setGeometry(QtCore.QRect(380, 300, 100, 100))
    ...
    def combo_change(self, text):
        ...
        con1 = pymysql.connect(host="192.168.0.19", user="root", password="1234", db='mydb', charset='utf8')
        # con2 = pymysql.connect(host="192.168.0.19", user="root", password="1234", db='mydb', charset='utf8')
        # con3 = pymysql.connect(host="192.168.0.19", user="root", password="1234", db='mydb', charset='utf8')
        # con4 = pymysql.connect(host="192.168.0.19", user="root", password="1234", db='mydb', charset='utf8')

        cur_name = con.cursor()
        cur_position = con1.cursor()
        # cur_id = con2.cursor()
        # cur_birth = con3.cursor()
        # cur_email = con4.cursor()
        ...
        data_position = cur_position.fetchone()
        # data_id = cur_id.fetchone()
        # data_birth = cur_birth.fetchone()
        # data_email = cur_email.fetchone()

        # Han_name = str(data_name[1])
        # Oh_name = str(data_name[2])
        # Jo_name = str(data_name[3])
        # Mun_name = str(data_name[4])
        # jang_name = str(data_name[5])
        ...
        self.namelabel_txt.setText(str(data_name[1]))

        # position_label_font = QtGui.QFont()
        # position_label_font.setPointSize(10)
        # position_label_font.setFamily("G마켓 산스 TTF Light")
        # self.position_label.setFont(position_label_font)
        # self.positionlabel_txt.setText(Han_position)
...
class sudo_menu_editmenu(QMainWindow):
    def __init__(self, parent=None):
        ...
        idlabel_txt_font.setFamily("G마켓 산스 TTF Light")
        self.idlabel_txt.setFont(idlabel_txt_font)
        self.idlabel_txt.setGeometry(QtCore.QRect(360, 255, 100, 30))
...
class editalarm_window(QMainWindow):
    ...
    def accept_btn_clicked(self):
        ...
        accept_btn_dialogs = sudo_menu(self)
        self.accept_btn_dialogs.append(accept_btn_dialogs)
        accept_btn_dialogs.show()
...
class deletealarm_window(QMainWindow):
    ...
    def accept_btn_clicked(self, event):
        editalarm_window.close(editalarm_window)
        # sudo_menu_editmenu.close()
        accept_btn_dialogs = sudo_menu(self)
        self.accept_btn_dialogs.append(accept_btn_dialogs)
        accept_btn_dialogs.show()
...
class First(QMainWindow):
 ...
 + "\n수신 : " + str(data) + "\n")
    ...
    def database_btn_clicked(self):
        ...
        cur = con.cursor()
        # curs = con.cursor()
        sql = "select distinct position from user_info;"
        cur.execute(sql)
        # con.commit()
        data = cur.fetchall()
        # data1 = curs.fetchone()
        # self.recv_txtB.setText(str(cur.execute(sql)))
        self.recv_txtB.append(str(list(data[1])))
